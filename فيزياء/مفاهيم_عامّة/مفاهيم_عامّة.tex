...
\NewEnviron{amath}{\hfill\begin{math}\rbox{\BODY}\end{math}\hfill}
\NewEnviron{aequation}{\begin{equation}\rbox{\BODY}\end{equation}}

\newtheorem{principe}{\LARGE مبدأ}[chapter]
\newtheorem{definition}{\LARGE مفهوم}[chapter]
\newtheorem{property}{\LARGE خاصّيّة}[chapter]
